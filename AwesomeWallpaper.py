...
headers = {"Referer": "https://alpha.wallhaven.cc/", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36"}

executor = None

# 主页url
home_url = "https://alpha.wallhaven.cc"
# 登录url
...
def addressing(previews):
    ...
    for i, url in enumerate(previews):
        try:
            ...
            if img_url:
                downloads.append("https:{}".format(img_url))
            else:
